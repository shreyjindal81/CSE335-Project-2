...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
    ...
    ON_COMMAND(ID_CHANGEMACHINE_MACHINE1, &CMainFrame::OnChangemachineMachine1)
END_MESSAGE_MAP()
...
///called on change machine number
void CMainFrame::OnChangemachineMachine1()
{
    mPicture->GetMachineDrawables()[0]->CallMachineDlg();
    mPicture->UpdateObservers();
}
