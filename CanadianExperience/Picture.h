...
public:
    ...
    */
    ...
    virtual void AddMachineDrawable(std::shared_ptr<CMachineDrawable> d) { mMachineDrawables.push_back(d); };

    ///get the machine list
    /// \returns machine list 
    virtual std::vector<std::shared_ptr<CMachineDrawable>> GetMachineDrawables() { return mMachineDrawables; };
...
private:
    ...
    //! The machine drawables
    std::vector<std::shared_ptr<CMachineDrawable>> mMachineDrawables;
};
